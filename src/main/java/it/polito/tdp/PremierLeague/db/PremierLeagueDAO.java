...
public class PremierLeagueDAO {
	...
	public void PartiteDelMese(int mese, Map<Integer, Match> idMap){
		String sql = "SELECT m.MatchID, m.TeamHomeID, m.TeamAwayID, m.teamHomeFormation, m.teamAwayFormation, m.resultOfTeamHome, m.date, t1.Name, t2.Name   "
				+ "FROM Matches m, Teams t1, Teams t2 "
				+ "WHERE m.TeamHomeID = t1.TeamID AND m.TeamAwayID = t2.TeamID "
				+ "AND MONTH(m.date) = ?";
	...
	public List<Adiacenza> getArchi(int mese, int min, Map<Integer, Match> idMap){
		String sql = "SELECT m1.MatchID, m2.MatchID, COUNT(DISTINCT a1.PlayerID) AS peso "
				...
				+ "AND m1.MatchID > m2.MatchID AND a1.PlayerID = a2.PlayerID "
